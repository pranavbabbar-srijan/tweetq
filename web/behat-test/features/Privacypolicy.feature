Feature: To verify Privacy policy page

@1
Scenario: Click on terms of use should navigate privacy policy page
	Given I am on "./"
	And I click "Privacy Policy"
	Then the url should match "/privacy-policy"
...
Scenario: To verify content block (Title , image,  heading , paragraph)
	...
	Then I should see element with xpath "//div[@id='block-mainpagecontent']//div[@class='node__content clearfix']/div[1]/img"
	And I should see element with xpath "//div[@id='block-pagetitle']/div/h1/span"
