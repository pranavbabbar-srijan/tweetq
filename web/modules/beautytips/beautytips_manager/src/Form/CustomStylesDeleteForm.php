  ...
  public function buildForm(array $form, FormStateInterface $form_state, $id = NULL) {
    ...
    if ($this->style->name == \Drupal::config('beautytips.basic')->get('beautytips_default_style')) {
      return array(
        'warning' => array(
          '#type' => 'markup',
          '#markup' => t('You cannot delete this style because is set as the default style. You may change this !link.', array('!link' => \Drupal::l(t('here'), Url::fromRoute('beautytips.config')))),
        ),
      );
    }
    else {
