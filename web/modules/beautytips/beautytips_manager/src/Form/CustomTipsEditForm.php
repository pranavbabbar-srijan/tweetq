...
class CustomTipsEditForm implements FormInterface {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $id = NULL) {
    ...
    if (\Drupal::currentUser()->hasPermission('use Javascript for custom beautytip display')) {
    ...
    $form['delete'] = array(
      ...
      '#url' => Url::fromUserInput("/admin/config/user-interface/beautytips/custom-tips/$id/delete", array('query' => array('destination' => "admin/config/user-interface/beautytips/custom-tips/$id/edit"))),
